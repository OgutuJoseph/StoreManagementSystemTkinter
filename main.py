...
conn = sqlite3.connect("C:/Users/Onyie/Documents/PythonProjects/Store Management System/Database/store.db") 
c = conn.cursor()
...
class Application:
    def __init__(self, master, *args, **kwargs):
        ...
        #components
        self.heading = Label(self.left, text="Neo Traders Store", font=('arial 40 bold'), bg='white')
    ...
    def add_to_cart(self, *args, **kwargs):
        ...
        if self.quantity_value > int(self.get_stock):
            ...
            for self.p in products_list:
                ...
                #total configure
                self.total_l.configure(text="Total: Ksh. " + str(sum(product_price)))
    ...
    def generate_bill(self, *args, **kwargs):
        ...
        directory = "C:/Users/Onyie/Documents/PythonProjects/Store Management System/Invoice/" + str(date) + "/"
        if not os.path.exists(directory):
            os.makedirs(directory)

        #TEMPLATES FOR THE BILL
        company = "\t\t\t\tNeo Traders Store Ltd.\n"
